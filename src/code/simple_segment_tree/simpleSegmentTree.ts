function useSimpleSegmentTree<T>(inputArray: T[], operation: (a: T, b: T) => T, operationFallback: T) {
    ...
    function updateTree(node: number, start: number, end: number, index: number, value: T) {
    ...
    function queryTree(node: number, start: number, end: number, left: number, right: number): T {
